...
class Mik32Pin(boardgen.Pin):
    ...
    def add_af(self, af_idx, af_name, af):
        print("{}, {}, {}".format(af_idx, af_name, af))
        if af == "GPIO":
    ...
    def definition(self):
        ...
        base = "GPIO_{}_BASE_ADDRESS".format(port)
...
class Mik32PinGenerator(boardgen.PinGenerator):
    def __init__(self):
        # Use custom pin type above.
        super().__init__(pin_type=Mik32Pin, enable_af=True)
